...
from datetime import datetime, timezone # UTC run names
...
# Save each trained network in a UTC timestamped run folder.
def save_run():
    run_name = datetime.now(timezone.utc).strftime("%Y%m%dT%H%M%SZ")
    run_dir = os.path.join("saved_runs", run_name)
